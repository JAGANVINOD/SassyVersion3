...
BOT_TOKEN = os.environ.get('BOT_TOKEN', '6090965735:AAH0CTscUajaudPoNYyeM7BWxL8T8DfYy3c')
# Bot settings
...
NOR_IMG = environ.get('NOR_IMG', "https://telegra.ph/file/9c4b29ca1ec39cd1d3b12.jpg")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001455529478').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://jaganvinod123:jaganvinod123@cluster0.p6afdpp.mongodb.net/?retryWrites=true&w=majority&appName=AtlasApp")
DATABASE_NAME = environ.get('DATABASE_NAME', "jaganvinod123")
