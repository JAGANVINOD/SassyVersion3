    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer(url=f"https://t.me/{temp.U_NAME}?start={ident}_{file_id}")
                await query.answer('𝘾𝙝𝙚𝙘𝙠 𝙋𝙈, 𝙄 𝙝𝙖𝙫𝙚 𝙨𝙚𝙣𝙩 𝙛𝙞𝙡𝙚𝙨 𝙞𝙣 𝙥𝙢\moveandroll_ᴛᴇᴀᴍ', show_alert=True)
                return
            else:
        ...
        if AUTH_CHANNEL and not await is_subscribed(client, query):
            await query.answer("𝑰 𝑳𝒊𝒌𝒆 𝒀𝒐𝒖𝒓 𝑺𝒎𝒂𝒓𝒕𝒏𝒆𝒔𝒔, 𝑩𝒖𝒕 𝑫𝒐𝒏'𝒕 𝑩𝒆 𝑶𝒗𝒆𝒓𝒔𝒎𝒂𝒓𝒕 😒\moveandroll_ᴛᴇᴀᴍ", show_alert=True)
            return
        ident, file_id = query.data.split("#")
        files_ = await get_file_details(file_id)
        if not files_:
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴏᴡɴ ɪɴғᴏ', url='https://t.me/n_i_8_m_a_r_e')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('ʀᴇᴘᴏ', url='https://t.me/n_i_8_m_a_r_e'),
        ...
        buttons = [[
           InlineKeyboardButton('ʀᴇᴘᴏ', url='https://t.me/n_i_8_m_a_r_e'),
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/n_i_8_m_a_r_e')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='aswin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
